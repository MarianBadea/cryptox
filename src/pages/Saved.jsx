...
const SaveBtn = ({data}) => {
  ...
  return (
      <button
          className='outline-o border-0 bg-none cursor-pointer'
  ...
  return (
    ...
    >
        ...
        >
                ...
                <table className='w-full table-auto'>
                      ...
                      '>
                          <tr>
                              ...
                              <th className='md:py-4 hidden md:table-cell'>1H</th>        
                              <th className='md:py-4 hidden md:table-cell'>24H</th>        
                              <th className='md:py-4 hidden md:table-cell'>7D</th>        
                          </tr>
                      </thead>
                      <tbody>
                      {savedData.map( data => {
                          return (
                              ...
                              >
                                  ...
                                  <td 
                                      className={
                                          data.price_change_percentage_1h_in_currency > 0 ? 'text-green md:py-4 hidden md:table-cell' : "text-red md:py-4 hidden md:table-cell"
                                      }
                                  >{Number(data.price_change_percentage_1h_in_currency).toFixed(2)}%</td>        
                                  <td 
                                      className={
                                          data.price_change_percentage_24h_in_currency > 0 ? 'text-green md:py-4 hidden md:table-cell' : "text-red md:py-4 hidden md:table-cell"
                                      }
                                  >{Number(data.price_change_percentage_24h_in_currency).toFixed(2)}%</td>        
                                  <td 
                                      className={
                                          data.price_change_percentage_7d_in_currency > 0 ? 'text-green md:py-4 hidden md:table-cell' : "text-red md:py-4 hidden md:table-cell"
                                      }
            ...
            <button
              className='w-[2rem] ml-4 hover:scale-110 translate-all translate-ease absolute right-0 -top-10'
