...
const formatMarketCap = (number) => {
  ...
  return (
    <>
        <div
            className='flex flex-col mt-9 border border-grey-100 rounded'
        >
            { cryptoData ? 
                <table className='w-full table-auto'>
                    ...
                    '>
                        <tr className='text-center text-base'>
                            ...
                            <th className='md:py-4  hidden lg:table-cell'>1H</th>        
                            <th className='md:py-4  hidden lg:table-cell'>24H</th>        
                            <th className='md:py-4  hidden lg:table-cell'>7D</th>        
                        </tr>
                    </thead>
                    <tbody>
                    {cryptoData.map( (data)  => {
        ...
        <div className='flex flex-col gap-2 items-center justify-between mt-4 capitalize h-[2rem] text-white'>
            <Pagination />
            <span>Data by <a className='text-cyan' href='https://www.coingecko.com'  rel="noreferrer" target={"_blank"}>CoinGecko</a></span>
        </div>
    </>
  )
}
