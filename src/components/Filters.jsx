...
export const Filters = () => {
  ...
  return (
    <div className='w-full h-auto border-2 border-gray-100 text-white gap-3 pl-5 py-2
    rounded-lg flex flex-wrap items-center relative justify-between '
    >
          <Search />
          <div className='flex flex-wrap justify-between  gap-3 mr-7'>
            <form
            ...
            >
              ...
              <input
                ...
                className='w-16 bg-gray-200 placeholder:text-gray-100 rounded pl-2 required outline-0 border border-transparent
                  focus:border-cyan
                '
                ref={currencyRef}
              />
            ...
            <div className='flex'>
              <label htmlFor="" className='relative flex justify-center items-center'>
                ...
                <button
                  className='w-[2rem] ml-4 hover:scale-110 translate-all translate-ease relative right-0 top-0'
